...
public class CustomerRunner {
    public static void main(String[] args) {
        ...
        EducationDTO education27 = new EducationDTO("B.E", "NIT Trichy", 2010, 82.3);
        DetailsDTO details27 = new DetailsDTO("EMP011", "Network Engineering", education27, "IT");
        JobDTO job27 = new JobDTO("Network Engineer", "12 years", 1350000.0, details27);
        SecurityDTO security27 = new SecurityDTO("Manoj", "Day", true, job27);
        HouseDTO house27 = new HouseDTO("Independent House", 3, "Adyar, Chennai", security27);
        ...
        VehicleDTO vehicle27 = new VehicleDTO("TN07XY3456", "SUV", 2020, company27);
        DriverDTO driver27 = new DriverDTO("Suresh", 47, "DL667788", vehicle27);
        ...
        PassportDTO passport27 = new PassportDTO("P6789012", "Indian", 2031, country27);
        customers.add(new CustomerDTO("Ravi Kumar", "ravi.kumar@google.com", 37, passport27));

        EducationDTO education28 = new EducationDTO("M.Sc", "Oxford University", 2017, 89.0);
        DetailsDTO details28 = new DetailsDTO("EMP012", "Research & Development", education28, "Science");
        JobDTO job28 = new JobDTO("Research Analyst", "6 years", 1400000.0, details28);
        SecurityDTO security28 = new SecurityDTO("Grace", "Night", false, job28);
        HouseDTO house28 = new HouseDTO("Studio Apartment", 2, "Cambridge, UK", security28);
        CeoDTO ceo28 = new CeoDTO("Elon Musk", 53, "elon@tesla.com", house28);
        CompanyDTO company28 = new CompanyDTO("Tesla UK", "Automotive", 2017, ceo28);
        VehicleDTO vehicle28 = new VehicleDTO("UK89ZX3210", "Electric", 2022, company28);
        DriverDTO driver28 = new DriverDTO("Harry", 43, "DL654321", vehicle28);
        PresidentDTO president28 = new PresidentDTO("Rishi Sunak", 44, "Male", driver28);
        CountryDTO country28 = new CountryDTO("United Kingdom", "Europe", 68000000L, president28);
        PassportDTO passport28 = new PassportDTO("U3344556", "British", 2033, country28);
        customers.add(new CustomerDTO("Emily Clark", "emily.clark@tesla.com", 31, passport28));

        EducationDTO education29 = new EducationDTO("BBA", "Symbiosis University", 2015, 78.9);
        DetailsDTO details29 = new DetailsDTO("EMP013", "Operations", education29, "Logistics");
        JobDTO job29 = new JobDTO("Operations Manager", "8 years", 1250000.0, details29);
        SecurityDTO security29 = new SecurityDTO("Anil", "Day", true, job29);
        HouseDTO house29 = new HouseDTO("Flat", 3, "Kalyani Nagar, Pune", security29);
        CeoDTO ceo29 = new CeoDTO("Satya Nadella", 56, "satya@microsoft.com", house29);
        CompanyDTO company29 = new CompanyDTO("Microsoft India", "Software", 1990, ceo29);
        VehicleDTO vehicle29 = new VehicleDTO("MH14ZX7890", "Sedan", 2021, company29);
        DriverDTO driver29 = new DriverDTO("Rajan", 41, "DL112233", vehicle29);
        ...
        PassportDTO passport29 = new PassportDTO("P3344556", "Indian", 2032, country29);
        customers.add(new CustomerDTO("Deepa Joshi", "deepa.joshi@microsoft.com", 34, passport29));

        EducationDTO education30 = new EducationDTO("B.Sc IT", "Anna University", 2016, 80.0);
        DetailsDTO details30 = new DetailsDTO("EMP014", "Technical Support", education30, "Customer Service");
        JobDTO job30 = new JobDTO("Support Engineer", "7 years", 1000000.0, details30);
        SecurityDTO security30 = new SecurityDTO("Rahul", "Night", false, job30);
        HouseDTO house30 = new HouseDTO("Apartment", 2, "Velachery, Chennai", security30);
        CeoDTO ceo30 = new CeoDTO("Mark Zuckerberg", 41, "mark@meta.com", house30);
        CompanyDTO company30 = new CompanyDTO("Meta India", "Social Media", 2011, ceo30);
        VehicleDTO vehicle30 = new VehicleDTO("TN22LM6789", "Crossover", 2019, company30);
        DriverDTO driver30 = new DriverDTO("Mohan", 46, "DL998877", vehicle30);
        PresidentDTO president30 = new PresidentDTO("Narendra Modi", 74, "Male", driver30);
        CountryDTO country30 = new CountryDTO("India", "Asia", 1400000000L, president30);
        PassportDTO passport30 = new PassportDTO("P4455667", "Indian", 2031, country30);
        customers.add(new CustomerDTO("Arjun Iyer", "arjun.iyer@meta.com", 33, passport30));
